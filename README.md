...
src/
├── components/       # Componentes de la UI y el Canvas
├── hooks/            # Lógica de interacción y PDF
├── translations/     # Diccionarios ES/EN
├── assets/           # Tipografías y estilos globales
...
├── hooks/            # Interaction and PDF logic
